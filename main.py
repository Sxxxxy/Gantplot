...
# 读取三个CSV文件
df1 = pd.read_csv(r"D:\Codes\VsProject\HeatoperationplanplusOrder\page0.csv",header=None, encoding="GBK")
df2 = pd.read_csv(r"D:\Codes\VsProject\HeatoperationplanplusOrder\page1.csv",header=None, encoding="GBK")
df3 = pd.read_csv(r"D:\Codes\VsProject\HeatoperationplanplusOrder\page2.csv",header=None, encoding="GBK")
